<%@ Page Title="Búsqueda (Tránsito)"
    Language="vb"
    MasterPageFile="~/Site1.Master"
    AutoEventWireup="false"
    CodeBehind="BuscarTransito.aspx.vb"
    Inherits="DAYTONAMIO.BuscarTransito" %>
...
<asp:Content ID="ctMain" ContentPlaceHolderID="MainContent" runat="server">
  <div id="transitoScope" class="page">
    <div class="title">Búsqueda de Admisiones (solo <span class="status-chip">TRANSITO</span>)</div>
          ...
          <div class="table-wrap">
            <asp:GridView ID="gvAdmisiones" runat="server"
              ...
              <Columns>
                ...
                <asp:BoundField DataField="DiasTransito" HeaderText="DÍAS TRÁNSITO" SortExpression="DiasTransito" />
